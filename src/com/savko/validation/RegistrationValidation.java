...
public class RegistrationValidation {
    ...
    private static final String REGEX_FIRST_SYMBOL = "[a-z]";
    ...
    private static final short VALID_PASSWORD_LENGTH = 6;
    ...
    public static boolean validateRegistrationForm(String name, String lastName, String login,
        ...
        if(!checkField(name) || !checkField(lastName) || !checkField(login)) {
            result = false;
        }
        ...
        if (!password.isEmpty() && password.length() < VALID_PASSWORD_LENGTH) {
            result = false;
        }
