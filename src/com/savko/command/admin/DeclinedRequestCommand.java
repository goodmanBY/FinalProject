...
public class DeclinedRequestCommand implements Command {
    ...
    private final static Logger LOGGER = Logger.getLogger(DeclinedRequestCommand.class);
    ...
    public Action execute(HttpServletRequest request) throws CommandException {
        ...
        try {
            BookingService.getInstance().declineBookingRequest(Integer.parseInt(requestId), adminId);
